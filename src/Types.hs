...
instance Arbitrary Position where
  arbitrary = oneof [return QB, return RB, return WR, return TE, return DST]
...
newtype PlayerNameAndId = PlayerNameAndId
...
instance Arbitrary Player where
  arbitrary =
    Player <$> arbitrary <*> arbitrary <*> arbitrary <*> arbitrary <*> arbitrary <*>
    arbitrary
...
instance FromNamedRecord PlayerWithProjected where
  parseNamedRecord m =
    PlayerWithProjected <$> parseNamedRecord m <*> m .: "Projected"
